                ...
                <section class="alternativas">
                    <form action="">
                      ...
                      <label for="alternativa_c">
                        <input type="radio" id="alternativa_c" name="alternativa" valeu" ${alterarSinais(quiz.question[pergunta-1].options[2])}">
                        <div>
                            <span>C</span>
                      ...
                      <label for="alternativa_d">
                        <input type="radio" id="alternativa_d" name="alternativa" valeu"${alterarSinais(quiz.question[pergunta-1].options[3])}">
                        <div>
                            <span>D</span>
